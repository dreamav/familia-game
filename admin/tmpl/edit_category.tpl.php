                ...
                <div class="portlet-body">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-2 control-label">Название категории:
                            </label>
                            <div class="col-md-10">
                                <input type="text" class="form-control input-medium" name="category[label]" value="<?=empty($label)?'':$label?>" placeholder="<?=empty($label)?'':$label?>">
                            </div>
                        </div>
                        <div class="form-group">
...
jQuery(document).ready(function($) {
    ...
    $('#save_button').click(function(event) {
    	...
    	$.ajax({
    		url: '/admin/index.php?action=save_category',
    		type: 'post',
    		dataType: 'json',
    		data: form_data
    	})
