...
<div class="pd-wrap h50per questionText questionSelectImage <?=$answersCountCSSClass?>">
	<p><?=$q_data['q_text']?></p>
</div>

<div class="h40per <?= ( $q_data['q_type']==3 )?"question-select-image":"" ?>">
