...
class Facebook extends AbstractAdapter
{
    ...
    public function getAvatar()
    {
        ...
        if (isset($this->userInfo['id'])) {
            $result = 'http://graph.facebook.com/' . $this->userInfo['id'] . '/picture?type=square';
        }
    ...
    public function authenticate()
    {
        ...
        if (isset($_GET['code'])) {
            ...
            if (count($tokenInfo) > 0 && isset($tokenInfo->access_token)) {
                $params = array('fields'=>'id,email,name,link,gender,birthday','access_token' => $tokenInfo->access_token);
